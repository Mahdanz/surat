                    <!-- MODAL EDIT -->
                    <div class="modal fade" id="modaleditmasuk<?php echo $d['id_surat'] ?>" style="padding-bottom: 300px;
                                ...
                                <div class="modal-body">
                                    ...
                                    <form role="form" action="edit_masuk.php" method="get">
                                        ...
                                        <div class="mb-3">
                                            <div class="column">
                                                <label for="message-text" class="col-form-label"><i
                                                        class="fas fa-unlock-alt"></i> Sifat:</label>
                                                <div class="container">
                                                    - Kerahasiaan
                                                    <div class="col-lg-7">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="sifat"
                                                                value="U"
                                                                <?php if ($row['sifat'] == 'U') echo 'checked' ?>>
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="sifat"
                                                                value="R"
                                                                <?php if ($row['sifat'] == 'R') echo 'checked' ?>>
                                                    ...
                                                    <div class="col-lg-7">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="keaslian"
                                                                value="A"
                                                                <?php if ($row['keaslian'] == 'A') echo 'checked' ?>>
                                                            <label class="form-check-label" for="flexRadioDefault1">
                                                                Asli
                                                            </label>
                                                        </div>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="keaslian"
                                                                value="C"
                                                                <?php if ($row['keaslian'] == 'C') echo 'checked' ?>>
                                                            <label class="form-check-label" for="flexRadioDefault2">
                                                                Copy
                                                            </label>
                                                        </div>
                                        ...
                                        <div class="mb-3">
                                            <label for="formFile" class="form-label"><i class="fas fa-file-pdf"></i>
                                                File PDF: <label style="color: red;">Tidak dapat dirubah</label></label>
                                            <input class="form-control" disable id="formFile" name="nm_file"
                                                value="<?php echo $row['nm_file'] ?>" disabled>
                                        </div>
